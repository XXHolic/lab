...
var Sentry = (function (exports) {
  ...
  ***************************************************************************** */
  ...
  function addInstrumentationHandler(handler) {
      ...
      // console.info('handler',{type:handler.type,handlers})
  }
  /** JSDoc */
  function triggerHandlers(type, data) {
    // console.info('triggerHandlers',{type:type,data})
      var e_1, _a;
      ...
      try {
        for (var _b = __values(handlers[type] || []), _c = _b.next(); !_c.done; _c = _b.next()) {
          ...
          try {
            // console.info('triggerHandlers',type)
                  handler(data);
              }
              catch (e) {
...
// debugger
  ...
  var FetchTransport = /** @class */ (function (_super) {
      ...
      FetchTransport.prototype.sendEvent = function (event) {
        console.info('sendEvent event',event)
          var _this = this;
  ...
  var GlobalHandlers = /** @class */ (function () {
      ...
      GlobalHandlers.prototype._installGlobalOnUnhandledRejectionHandler = function () {
          ...
          addInstrumentationHandler({
              ...
              callback: function (e) {
                  var error = e;
                  // console.info('_onUnhandledRejectionHandlerInstalled',e)
      ...
      GlobalHandlers.prototype._enhanceEventWithInitialFrame = function (event, url, line, column) {
        // console.info('_enhanceEventWithInitialFrame',{event, url, line, column})
          event.exception = event.exception || {};
          event.exception.values = event.exception.values || [];
          event.exception.values[0] = event.exception.values[0] || {};
