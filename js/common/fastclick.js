;(function () {
	...
	*/
	...
	FastClick.prototype.sendClick = function(targetElement, event) {
		console.info('FastClick.prototype.sendClick');
		...
		// 触发自定义（合成）的事件，绑定的事件处理程序就会根据设置的属性触发，addEventListener是添加事件处理程序，可以添加多个，跟自定义的不冲突
	...
	FastClick.prototype.onTouchStart = function(event) {
		console.info('FastClick.prototype.onTouchStart');
	...
	FastClick.prototype.onTouchMove = function(event) {
		console.info('FastClick.prototype.onTouchMove');
	...
	FastClick.prototype.onClick = function(event) {
		console.info('FastClick.prototype.onClick');
		var permitted;
